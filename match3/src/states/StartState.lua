...
function StartState:init()
    ...
    self.colors = {
        [1] = {0.850, 0,341, 0.388, 1.0},
        [2] = {0.376, 0.804, 0.894, 1.0},
        [3] = {0.984, 0.949, 0.212, 1.0},
        [4] = {0.462, 0.243, 0.541, 1.0},
        [5] = {0.6, 0.898, 0.314, 1.0},
        [6] = {0.874, 0.443, 0.149, 1.0}
    }
...
function StartState:drawOptions(y)
    ...
    if self.currentMenuItem == 1 then
        ...
        love.graphics.setColor(0.188, 0.376, 0.509, 1.0)
    end
...
function StartState:drawTextShadow(text, y)
    love.graphics.setColor(0.13, 0.12, 0.204, 1.0)
